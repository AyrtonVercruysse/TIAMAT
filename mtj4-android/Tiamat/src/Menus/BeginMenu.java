...
public class BeginMenu extends Menu{
	...
	public BeginMenu(AbstractMTApplication mtApplication, String name) {
		super(mtApplication, name);
	}
	
	private MTListCell createListCell(final AbstractMTApplication mtApplication, final String label, final Menu menu, IFont font, float cellWidth, float cellHeight, final MTColor cellFillColor, final MTColor cellPressedFillColor){
		...
		cell.addGestureListener(TapProcessor.class, new IGestureEventListener() {
			public boolean processGestureEvent(MTGestureEvent ge) {
				...
				case TapEvent.BUTTON_CLICKED:
					...
					//FunctionsMenu beginmenu = new FunctionsMenu(mtApplication, "Tiamat");
					//beginmenu.Menu(mtApplication, "blur");
					System.out.println(menu);
					menu.Make(mtApplication, label);
					cell.setFillColor(cellFillColor);
