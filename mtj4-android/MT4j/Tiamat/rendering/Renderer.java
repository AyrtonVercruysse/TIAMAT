...
public abstract class Renderer<T extends Node> extends AbstractScene {
	MTRectangle drawing;
	protected T node;	
	public Renderer(MTApplication mtApplication, T ast) {
	...
	static MTTextArea makeText(MTApplication mtApplication, String text){
	...
	static MTTextArea makeTextArea(MTApplication mtApplication, String text, MTColor color){
